...
The current manuscript revision [manuscript-2026-09-09-r4](https://github.com/wang177777/fda-ai-clinical-function-annotations/releases/tag/manuscript-2026-09-09-r4) refines claim-to-source correspondence throughout the text and Table 3. It retains 31 references, with their first appearance matching the bibliography and each citation placed beside its supported claim or source row. See the [full citation revision note](docs/citation_audit_2026-09-09.md) and [current reference metadata](docs/references_verified.json). The earlier [introduction revision](docs/introduction_revision_2026-09-08.md) and [same-format reference-count comparison](docs/reference_revision_2026-09-08.md) describe r3 and r2 respectively.
